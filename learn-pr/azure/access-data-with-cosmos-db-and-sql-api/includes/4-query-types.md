...
Med hjälp av geospatiala frågor kan du köra spatiala frågor med GeoJSON-punkter. Med hjälp av koordinaterna i databasen kan du beräkna avståndet mellan två punkter och avgöra om en punkt, polygon eller linjesträng finns inom en annan punkt, polygon eller linjesträng.

För produktkatalogdata skulle detta göra det möjligt för dina användare att ange platsinformation och fastställa om det finns några butiker inom 80 km avstånd som har den artikel som användaren letar efter. 
