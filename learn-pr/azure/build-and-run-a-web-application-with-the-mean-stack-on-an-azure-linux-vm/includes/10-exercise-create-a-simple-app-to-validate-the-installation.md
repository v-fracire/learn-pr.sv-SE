I den här övningen skapar du ett enkelt AngularJS-program som hanteras i Node.js och använder Express för routning. I serverdelen fungerar MongoDB som datalager. Programmet är en bokdatabas där du kommer att kunna visa, lägga till och ta bort böcker.

> [!Important]
> Det här är ett enkelt program. Dess syfte är att testa den nyinstallerade MEAN-stacken. Det här programmet är inte tillräckligt säkert eller redo för produktionsanvändning.
...
1. Skapa datamodellserverdelen för bokwebbprogrammet med hjälp av Mongoose.
    ...
    1. Klistra in följande kod i den här nya filen för att skapa vårt bokschema med hjälp av Mongoose.
        ...
        > [!TIP]
        > Om du vill spara den aktuella filen i **nano** måste du trycka på **Ctrl**+**O**. Om du vill avsluta **nano** måste du trycka på **Ctrl**+**X**.
...
1. Skapa **server.js**-fil i mappen **Books** för att konfigurera Node.js-värdtjänsten (med hjälp av ExpressRoute-anslutningar).
