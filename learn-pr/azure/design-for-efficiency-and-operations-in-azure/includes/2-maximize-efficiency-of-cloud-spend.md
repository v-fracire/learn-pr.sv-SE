...
Azure Advisor identifierar vilka virtuella datorer som är underutnyttjade. Advisor övervakar din användning av virtuella datorer under 14 dagar och identifierar underutnyttjade virtuella datorer. Virtuella datorer vars CPU-användning är 5 procent eller mindre och nätverksanvändning är 7 MB eller mindre för fyra eller flera dagar betraktas underutnyttjade virtuella datorer.
