...
Vid asymmetrisk kryptering används ett par med en offentlig nyckel och en privat nyckel. Båda nycklarna kan kryptera, men de kan inte dekryptera sina egna krypterade data. För att dekryptera krävs den parade nyckeln. Asymmetrisk kryptering används bl.a. för TLS (används i https) och datasignering.
