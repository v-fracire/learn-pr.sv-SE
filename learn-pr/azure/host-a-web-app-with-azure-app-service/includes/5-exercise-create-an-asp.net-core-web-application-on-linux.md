<span data-ttu-id="c667a-101">I den här enheten skapar en ASP.NET Core-webbapp.</span><span class="sxs-lookup"><span data-stu-id="c667a-101">In this unit, you will create an ASP.NET Core web app.</span></span>
