...
![En bild som visar en avsändare som skickar meddelanden till flera mottagare via ett ämne som innehåller tre prenumerationer. Dessa prenumerationerna används av tre mottagare för att hämta relevanta meddelanden.](../media/2-service-bus-topic.png)
