Nu är det dags att köra vår app i Azure. Vi måste skapa en Azure App Service-app, konfigurera den med en hanterad identitet och vår vault-konfiguration och distribuera vår kod.
